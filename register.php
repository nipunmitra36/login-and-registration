...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if ($password == "") {
        ...
        data_protect($password);
    }
    if ($com_password == "") {
        echo "Please enter confrom password";
    } else {
        if( data_protect($password)==data_protect($com_password) && str_word_count($password)>=6){
            echo "Password Ok";
        }
        else{
            echo "Password not match and minimum 6 digits required";
        }
    }
}
            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="<?php htmlspecialchars(trim($_SERVER["PHP_SELF"]))?>" method="POST" novalidate>
                            <div>
